...
// Repair "mojibake": UTF-8 bytes that got decoded as Latin-1/Windows-1252.
// Feeds are UTF-8, but smart punctuation (’ “ ” — …) sometimes arrives as the
// telltale sequences â€™, â€œ, â€" etc. Map the common ones back to real glyphs.
const MOJIBAKE = [
  ...
  [/\u00e2\u20ac\u201c/g, '\u2013'], // – en dash
  [/\u00e2\u20ac\u00a6/g, '\u2026'], // … ellipsis
  [/\u00e2\u20ac/g,       '\u201d'], // bare â€ → ” (fallback for truncated seqs)
  [/\u00c3\u00a9/g, '\u00e9'],       // é
  [/\u00c3\u00a8/g, '\u00e8'],       // è
  [/\u00c3\u00b1/g, '\u00f1'],       // ñ
  [/\u00c2\u00a0/g, ' '],            // stray non-breaking space
];
function fixMojibake(s) {
  if (!s || s.indexOf('\u00e2') === -1 && s.indexOf('\u00c3') === -1 && s.indexOf('\u00c2') === -1) return s;
  let out = s;
